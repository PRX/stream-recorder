...
describe("config", () => {
  ...
  describe("#recordTimes", () => {
    it("combines configs with their hour start/stop times", () => {
      ...
      const job_id = "123/456/:date/:hour";
      const times = recordTimes({ what_ev: "val", url, job_id }, new Date("2025-12-09T21:58Z"));
      ...
      expect(times[0].jobId).toEqual("123/456/2025-12-09/21");
      ...
      expect(times[1].jobId).toEqual("123/456/2025-12-09/22");
    });
  });
